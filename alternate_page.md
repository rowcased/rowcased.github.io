...
At first I only solved kata in Python just to learn to code, next I learned C and translated kata into that language, then I studied additional languages, and finally I created some original kata. As my honor gradually inceased, I evolved into an ad hoc site moderator with access to site maintainance and participating in guiding new members to the community.
