...
First I only solved kata in Python to learn coding, later I began translated kata into C, then I added on some additional languages, and eventually I created several original kata. As I earned additional honor and advanced in the ranks, I evolved from user to contributor to an ad hoc site moderator.
