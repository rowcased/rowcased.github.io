...
#### The Short Story<br>
While studying C, I tried writing a translation of kata previously solved in Python. A moderator reviewed it, and after I made some revisions it was approved for use on the website. I enjoyed the experience and just kept making translations. I enjoy supporting the C language and I like the idea that coders all around the world are honing their skills on the random tests suites I constructed for use on the wensite.
