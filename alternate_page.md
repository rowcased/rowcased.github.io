...
At first I only solved kata in Python to learn how to code, next I learned C and translated kata into that language, then I studied some additional languages, and finally I created several original kata. As I earned more honor and advanced in the ranks, I evolved from user to contributor to moderator; providing maintainance to kata, ranking beta submissions, and guiding new members.
...
*   817 additional solves in alternate languages
    ...
    1 Python     1,643   <--  I guess this needs to be a break out list...
    2 JavaScript   478
    3 C            445
    4 Ruby         104
    5 C#            66
