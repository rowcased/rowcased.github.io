...
In conjunction with tutorials, videos, blogs, and language docs, this is where I really learned how to code. I thrived on reading and studying other people's solutions. I followed up on comments about readability, best practices, optimization, and maintainability. Solving the same code in multiple languages was invaluable. I never thought I'd solved so many.
<br>
