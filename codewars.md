...
Codewars only just recently assigned a few moderators. Still, the site is regularly maintained by an unofficial network of power-users with full privileges. On any given day I may take part in a variety of activities to assist users with code or contribute to maintaining the overall quality of the site.
