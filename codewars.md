...
A fascination with core differences between Python and C lead me to create translations for the site. I developed a very streamlined code structure and wrote a lot of strong unit tests with quality feedback. I like that new coders around the world are improving their skills via my test suites.
