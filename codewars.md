...
A fascination with language differences between Python and C lead me to create translations for use on the site. I learned about code structure, syntax, maintainability, paradigms, edge cases, and unit testing. I like that new coders around the world are improving their skills via my test suites.
