...
With no experience to begin with, I had to quickly learn how to learn; studying other coders' solutions, reading comments, and using tutorials. I found solving kata in multiple languages offered invaluable insights to coding, plus using documentation to more rapidly learn a new language.
