...
Codewars is built entirely on user contributions, where each new kata submissions must survive the user voting system to even be considered for approval. My experience creating original kata has been very rewarding, enjoying total control over concept, design, execution, and code structure.
