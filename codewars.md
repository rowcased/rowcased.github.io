...
A fascination with language differences between Python and C lead me to create translations for the site. I learned about code structure & maintainability, following specs, edge cases, and unit testing. I like that new coders around the world are improving their skills via my test suites.
...
Codewars is built entirely on user contributions. Each new kata is submitted in beta form to undergo quality consideration by the comminity prior to approval. My experience with creating these original kata was very rewarding, as I had total control over concept, design, execution and code structure.
