...
A fascination with language differences between Python and C lead me to create translations for use on the site. I learned about structure, maintainability, syntax, and writing unit tests. I like that coders are using my test suites to improve their skills.
